...
#define LOG(level, exception, ...)                                                                                                         \
    do                                                                                                                                     \
        {                                                                                                                                  \
           Toy::Debug::Log<exception>(level, __FILE__, __T_FUNC__, __LINE__ __VA_OPT__(,) ##__VA_ARGS__);                                                        \
    } while (false)

#define LOG_FORMAT(level, exception, format, ...)                                                                                          \
    do                                                                                                                                     \
        {                                                                                                                                  \
            Toy::Debug::LogFormat<exception>(level, __FILE__, __T_FUNC__, __LINE__ __VA_OPT__(,)  format, ##__VA_ARGS__);                                          \
    } while (false)

#define LOG_INFO(...)                                                                                                                      \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG(Toy::Debug::LOG_LV_INFO, false __VA_OPT__(,)  ##__VA_ARGS__);                                                                            \
    } while (false)
...
#define LOG_INFO_FORMAT(format, ...)                                                                                                       \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG_FORMAT(Toy::Debug::LOG_LV_INFO, false, format __VA_OPT__(,)  ##__VA_ARGS__);                                                             \
    } while (false)
...
#define LOG_WARNING(...)                                                                                                                   \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG(Toy::Debug::LOG_LV_WARNING, false __VA_OPT__(,)  ##__VA_ARGS__);                                                                         \
    } while (false)
...
#define LOG_WARNING_FORMAT(format, ...)                                                                                                    \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG_FORMAT(Toy::Debug::LOG_LV_WARNING, false, format __VA_OPT__(,)  ##__VA_ARGS__);                                                          \
    } while (false)
...
#define LOG_ERROR(...)                                                                                                                     \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG(Toy::Debug::LOG_LV_ERROR, false __VA_OPT__(,)  ##__VA_ARGS__);                                                                           \
    } while (false)
...
#define LOG_ERROR_EXCEPTION(...)                                                                                                           \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG(Toy::Debug::LOG_LV_ERROR, true __VA_OPT__(,)  ##__VA_ARGS__);                                                                            \
    } while (false)
...
#define LOG_ERROR_FORMAT(format, ...)                                                                                                      \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG_FORMAT(Toy::Debug::LOG_LV_ERROR, false, format __VA_OPT__(,)  ##__VA_ARGS__);                                                            \
    } while (false)
...
#define LOG_ERROR_EXCEPTION_FORMAT(format, ...)                                                                                            \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG_FORMAT(Toy::Debug::LOG_LV_ERROR, true, format __VA_OPT__(,)  ##__VA_ARGS__);                                                             \
    } while (false)
...
#define LOG_FATAL_ERROR(...)                                                                                                               \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG(Toy::Debug::LOG_LV_FATAL_ERROR, false __VA_OPT__(,)  ##__VA_ARGS__);                                                                     \
    } while (false)
...
#define LOG_FATAL_ERROR_EXCEPTION(...)                                                                                                     \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG(Toy::Debug::LOG_LV_FATAL_ERROR, true __VA_OPT__(,)  ##__VA_ARGS__);                                                                      \
    } while (false)
...
#define LOG_FATAL_ERROR_FORMAT(format, ...)                                                                                                \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG_FORMAT(Toy::Debug::LOG_LV_FATAL_ERROR, false, format __VA_OPT__(,)  ##__VA_ARGS__);                                                      \
    } while (false)
...
#define LOG_FATAL_ERROR_EXCEPTION_FORMAT(format, ...)                                                                                      \
    do                                                                                                                                     \
        {                                                                                                                                  \
            LOG_FORMAT(Toy::Debug::LOG_LV_FATAL_ERROR, true, format __VA_OPT__(,)  ##__VA_ARGS__);                                                       \
    } while (false)
